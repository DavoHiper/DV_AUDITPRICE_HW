...
Public Class Coleta
    ...
    Public Sub gravaArquivo(ByVal evento)
        ...
        flOutput = IO.File.AppendText("\Honeywell\DAVO\APLICACOES\AUDITPRICE\OUT\" & "I" & Arquivo & ".txt")
    ...
    Sub moveArquivo()
        ...
        IO.File.Move("\Honeywell\DAVO\APLICACOES\AUDITPRICE\IN\" + "C" + Arquivo, "\Honeywell\DAVO\APLICACOES\AUDITPRICE\IN\PROC\" + "C" + Arquivo)
